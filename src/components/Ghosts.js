...
const onryo_evidences_icons       = [freezingTemp,    ghostOrbs,      spiritBox];
...
const shade_evidences_icons       = [ghostWriting,    freezingTemp,      emf5];
